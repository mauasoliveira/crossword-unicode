...
Crossword.prototype.clearCanvas = function (resetPuzzle, fillStyle) {
  this.ctx.fillStyle = fillStyle || '#000';
  this.ctx.fillRect(0, 0, this.boxSize * this.width, this.boxSize * this.height);
...
Crossword.prototype.drawGrid = function (x, y) {
  ...
  this.ctx.fillRect(x * this.boxSize + this.spacing, y * this.boxSize + this.spacing, this.boxSize - (2* this.spacing), this.boxSize - (2* this.spacing));
  if (letter.label) {
    this.ctx.fillStyle = '#000';
    this.ctx.fillText(this.numberTransform(letter.label), x * this.boxSize + 8, y * this.boxSize + 15);
  }
};
